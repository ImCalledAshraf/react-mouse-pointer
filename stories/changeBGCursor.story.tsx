...
export const Docs = () => <ShowDocs md={require('../docs/changeBackgroundCursor.md')} />;
export const Demo = () => {
  ...
  const backgroundImageAnimationDurationOnHover = number(
    '<CursorStyle>backgroundImageAnimationDuration',
    0
  );
        ...
        <CursorStyle
          ...
          <div
            ...
            <h1 style={{ margin: '0' }} id="stick-title">
              Change Cursor Background Image
            </h1>
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ margin: '0' }}>
                ...
                {/*----*/}
                cursorBackgroundImageScale = &#123;{backgroundImageScale}&#125; <br />
                {/*----*/}
                cursorBorderRadius = &#123;'{cursorBorderRadiusOnHover}'&#125; <br />
                {/*----*/}
