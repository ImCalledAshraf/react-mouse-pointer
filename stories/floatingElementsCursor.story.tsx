      ...
      <div style={{ height: '95vh', display: 'grid', placeItems: 'center' }}>
        ...
        >
          <div
            ...
            <h1 style={{ margin: '0' }} id='stick-title'>Float Effect</h1>
            ...
            <div style={{textAlign:'left'}}>
              ...
              <div style={{ margin: '0' }}>
                <b> &lt;CursorStyle </b> <br /> float
                = &#123;true&#125; <br />
                {/*----*/}
                floatAmount
                = &#123;{cursorFloatAmount}&#125; <br />
                {/*----*/}
                floatDuration
                = &#123;'{cursorFloatDuration}'&#125; <br />
                {/*----*/}
                {cursorFloatFollow ?  <div> floatFollow = &#123;true&#125; </div> : <div> floatFollow = &#123;false&#125; </div>}

                {/*----*/}
                floatTriggerOffset
                = &#123;'{elementFloatTriggerOffset}'&#125;
                {/*----*/}
              </div>
              {elementFloatSpringToPosition ?  <div> floatSpringToPosition = &#123;true&#125; </div> : <div> floatSpringToPosition = &#123;false&#125; </div>}
