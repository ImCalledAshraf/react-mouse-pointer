...
export const Docs = () => (
  <ShowDocs md={require('../docs/tiltElements.md')} />
);
export const Demo = () => {
        ...
        >
            <div id='cube-container'>
              ...
              <div className='face back'>
                <h1 style={{ margin: '0' }} id='stick-title'>Tilt Element</h1>
