...
export const Docs = () => <ShowDocs md={require('../docs/changeColorCursor.md')} />;
export const Demo = () => {
  ...
  const cursorBackgroundColorOnHover = text(
    '<CursorStyle>Cursor Background Color On Hover',
    'orange'
  );
      ...
      <div style={{ height: '95vh' }}>
        ...
        <CursorStyle cursorBackgroundColor={cursorBackgroundColorOnHover}>
          <div
            ...
            <p style={{ margin: '0' }}>
              Wrapped with <b> &lt;CursorStyle </b> cursorBackgroundColor=&#123;'
              {cursorBackgroundColorOnHover}'&#125;&#62; <b> &#125;&#62; &lt;/CursorStyle&gt;</b>{' '}
            </p>
          </div>
        </CursorStyle>
        ...
        <br />
        <br />
        <CursorStyle cursorOutlineColor={cursorOutlineColorOnHover}>
          <div
            style={{
            ...
            <h1 style={{ margin: '0' }} id="stick-title">
              Change Cursor Outline Color
            </h1>
            <h3 style={{ margin: '0' }}>Hover To see Effect</h3>
            <p style={{ margin: '0' }}>
              Wrapped with <b> &lt;CursorStyle </b> cursorOutlineColor=&#123;'
              {cursorOutlineColorOnHover}'&#125;&#62; <b> &#125;&#62; &lt;/CursorStyle&gt;</b>{' '}
            </p>{' '}
          </div>
        </CursorStyle>
      </div>
