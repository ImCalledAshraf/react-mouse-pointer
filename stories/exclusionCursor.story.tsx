...
export const Docs = () => <ShowDocs md={require('../docs/exclusionCursor.md')} />;
export const Demo = () => {
  ...
  const demoComponent = () => {
    return (
      <body style={{ height: '95vh' }}>
        ...
        />
        <CursorStyle exclusion={true} exclusionBackgroundColor={cursorExclusionBackgroundColor}>
          <div
            style={{
              borderRadius: '20px',
              background: '#c5ded8',
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ margin: '0' }}>
                <b> &lt;CursorStyle </b> <br /> exclusion = &#123;true&#125; <br />
                {/*----*/}
