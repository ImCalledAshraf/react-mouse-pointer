...
const Demo = () => {
  return (
    <body style={{ 'height': '100vh' , display : 'grid' , placeItems: 'center' }}>
      ...
      <div  data-cursor-transparent style={{background:'red','width':'50px' ,  height : '50px'}}>
        <img data-cursor-transparent id="stick-title" src={"/images/icon.png"} height={50} width={50}/>
      </div>
    </body>
  );
};

storiesOf('Cursor/Transparent', module)
